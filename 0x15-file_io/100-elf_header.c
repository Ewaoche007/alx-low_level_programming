 ...
 *
 * Description: Magic number that are separated by spaces.
 */
void print_magic(unsigned char *e_ident)
{
	int index;
...
/**
 *  * print_version - Prints a version of an ELF header.
...
/**
 * print_osabi - Prints an OS/ABI of an ELF header.
...
/**
 * print_abi - Prints an ABI version of an ELF header.
 ...
 * @argv: An array of pointers to a arguments.
 *
 * Return: 0 on success.
 *
